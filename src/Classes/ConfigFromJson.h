...
public:
	...
	std::map <std::string, std::map <std::string, std::string>>& getOptions(void) { return _mOptions;  }	// returns the map of lexer:<optionName:optionVal>
...
private:
	...
	std::map <std::string, std::map <std::string, std::string>> _mOptions;	// maps lexer:<optionName:optionVal>
